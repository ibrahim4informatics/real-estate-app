        ...
        <Layout >
                ...
                <Box w={"100%"} h={"100%"} bg={'rgba(0,0,0,0.5)'}>
                    ...
                    <Container>
                        ...
                        <InputGroup size={'lg'} mt={4} >
                            ...
                            <InputRightElement>
                                <IconButton bg='white !important' color={'black'} icon={<MdSearch />} />
                            </InputRightElement>
                        </InputGroup>
            ...
            <Box mt={8} alignItems={'center'} justifyContent={{ base: 'center', md: 'start' }} flexWrap={'wrap'} py={4} w={'70%'} maxW={650} marginInline={'auto'} display={'flex'}>
                ...
                <Box flex={1} py={2} >
                    ...
                    <Button variant={'solid'} colorScheme='blue' mt={2} mb={1} size={'lg'} onClick={() => setShowSignIn(true)}>Commencer</Button>
                </Box>
